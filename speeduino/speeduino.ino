...
void loop()
{
    ...
    */
    ...
    {
        if((currentStatus.startRevolutions >= configPage4.StgCycles) && (configPage4.TrigPattern != 17))  { ignitionOn = true; fuelOn = true; } //Enable the fuel and ignition, assuming staging revolutions are complete
      ...
      {
        if((configPage2.hardCutType == HARD_CUT_FULL) && (configPage4.TrigPattern == 17)) { ignitionOn = false; }
        else 
        { 
